 ...
 */
    public class Rotas {
            ...
            public static final String ADICIONAR_PRODUTO_VIEW = rota("produtos/adicionar-produto.fxml");
            public static final String GERENCIAR_PRODUTO_VIEW = ADICIONAR_PRODUTO_VIEW;
